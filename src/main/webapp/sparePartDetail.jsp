...
<div class="frame">
    ...
    <c:if test="${empty part}">
        <p>Spare part not found.</p>
    </c:if>
    <c:if test="${not empty part}">
        <div class="row"><span class="label">ID:</span> ${part.idPart}</div>
        <div class="row"><span class="label">Spare part name:</span> ${part.name}</div>
        <div class="row"><span class="label">Quantity:</span> ${part.quantity}</div>
        <div class="row"><span class="label">Price:</span> ${part.sellPrice.intValue()} VND</div>
